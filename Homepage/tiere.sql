...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 20. Jan 2026 um 12:39
...
CREATE TABLE `hunde` (
  ...
  `Name` text NOT NULL,
  `Age` int(11) NOT NULL,
  `Vorerfahrung` tinyint(1) NOT NULL,
  `vermittelbar` varchar(255) NOT NULL,
...
(1, 'Pesto', 'Ratte', 'Nein - Patenschaft möglich', 'Aufgrund eines zu frechen Charakters leider nicht vermittelbar.', 'adoptiere\\kleintiere\\Pesto.jpg'),
(2, 'Schnuppi', 'Hamster', 'Ja', 'Die kleine Hamsterdame Schnuppi sucht nach einem schönen neuen Zuhause mit einem geräumigen und spannend eingericheten Gehege! ', 'adoptiere\\kleintiere\\Schnuppi.jpg'),
(3, 'Konrad', 'Wühlmaus', 'Nein - Patenschaft möglich', 'Konrad wurde verletzt aufgefunden und wird von unserem Team gepflegt, steht aber nicht zur Vermittlung frei.', 'adoptiere\\kleintiere\\Konrad.jpg');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `mauser`
--

CREATE TABLE `mauser` (
  `id` int(11) NOT NULL,
  `mitarbeiter` varchar(25) NOT NULL,
  `MApw` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Daten für Tabelle `mauser`
--

INSERT INTO `mauser` (`id`, `mitarbeiter`, `MApw`) VALUES
(1, 'MA1', '$2y$10$OzHZB6cvEIVdQzWPjaWSQOT.5h/e3mASV.Bi7tIewZFysd.5s/D/S'),
(2, 'MA2', '$2y$10$M..42B/G9j6b654VuDfQHeObYCD..kgSz51Z85AVfZ5Ofmf/Dn4Ae');
...
(1, 'Barbara', 'Wellensittich', 'Ja', 'Barbara braucht viel Vorerfahrung und einen sicheren Besitzer, der sie auch medizinisch versorgen kann.', 'adoptiere\\vogel\\Babs.jpg'),
(2, 'Diana', 'Taube', 'Nein - Patenschaft möglich', 'Diana kann zurzeit leider nicht vermittelt werden.', 'adoptiere\\vogel\\Taube.jpg');
...
--
-- Indizes für die Tabelle `ituser`
--
ALTER TABLE `ituser`
  ADD PRIMARY KEY (`id`);
...
--
-- Indizes für die Tabelle `mauser`
--
ALTER TABLE `mauser`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT für Tabelle `ituser`
--
ALTER TABLE `ituser`
...
--
-- AUTO_INCREMENT für Tabelle `mauser`
--
ALTER TABLE `mauser`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
